...
%       * A name string (Name)
%
%       * A string (LengthUnit) indicating the units of the semimajor and
%         semiminor axes
%
...
%   corresponding to the string, NAME. NAME can be one of the short names
%   or long names in the following table.  The values of the SemimajorAxis
%   and SemiminorAxis properties are in meters.  Note that 'earth' is
...
%   length unit. LENGTHUNIT can be any length unit string supported by
%   validateLengthUnit.
%
...
%
%   See also oblateSpheroid, referenceSphere, validateLengthUnit, wgs84Ellipsoid.
...
% Copyright 2011-2012 The MathWorks, Inc.
    ...
    properties
        ...
        %Name Name of reference ellipsoid
        %
        %   A string naming or describing the ellipsoid, for example,
    ...
    methods
        function self = referenceEllipsoid(arg1,lengthUnit)
            ...
            %   object corresponding to the string, NAME. The values of the
            ...
            %   any length unit string supported by validateLengthUnit.
            %
            %   Example
            %   -------
            ...
            if nargin > 0
                ...
                if ~ischar(arg1)
                    % The first input is non-char, so it should be a
                ...
                elseif any(strcmpi(removeSpaces(arg1),wgs84Strings))
                    ...
                    % The first input is char, so it should be an ellipsoid
                    % name.
                    name = arg1;
                    
                    % Select a row from the Ellipsoids cell array, matching
                    % the input string against either the second or last
                    % column.  Ignore spaces in the input string and in the
                    % Ellipsoids array.
